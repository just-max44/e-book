...
@section('content')
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-6 mx-auto box mt-3">
                ...
                <form action="{{ route('checkout.store') }}" method="POST" class="my-4" id="payment-form">
                    ...
                    <button class="btn btn-success btn-block mt-5" id="submit" type="submit">
                        <i class="fa fa-credit-card" aria-hidden="true"></i> Payer maintenant ({{ formatPrice(Cart::total()) }})
                    </button>
                </form>
            </div>
        </div>
...
@section('extra-js')
    <script>
        ...
        // Paiement Stripe
        var stripe = Stripe('pk_test_51KjkehJNxQAUDjKZ9pBlmR7ETbigdTtC3KcPd6GXHdwsBOiE6x1cWfdypmNyVVXF6VCVN8DSXuW5gWeptyNGiD5d00hHnWwiAo');
